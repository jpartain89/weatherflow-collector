docker run --rm \
  --name=weatherflow-collector-LBrookhaven_Dr-remote-import \
  ...
  -e WEATHERFLOW_COLLECTOR_HOST_HOSTNAME=Justins-iMac.local \
  -e WEATHERFLOW_COLLECTOR_IMPORT_DAYS=365 \
  ...
  -e WEATHERFLOW_COLLECTOR_LOGCLI_URL= \
